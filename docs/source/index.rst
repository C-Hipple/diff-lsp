...
See `Documentation <https://diff-lsp.readthedocs.io/en/latest/>`_ for full docs
...
See `diff-lsp.el <https://www.github.com/C-Hipple/diff-lsp.el>`_ for configuring & running with emacs.

diff-lsp.el sets up diff-lsp for both magit status and `code-review <https://www.github.com/C-Hipple/code-review>`_ buffers.
